...
> **决赛提交要求已明确（2026-09-24 拿到官方模板 `hackathon-决赛入围定稿作品提交模板-天池版.docx`）**：主文档＝**填写后的该模板**（.docx/.pdf），连同 Demo.zip / 演示视频.mp4 / 其他材料.zip 打进**一个** zip，命名 `团队名_方案名称_决赛入围定稿作品.zip`；模板 5.2 要求填"阿里云百炼模型"表（本项目未使用百炼，须如实填"未使用"）。逐条要求、与复赛模板的差别、交付物映射见 `docs/finals_stage.md` §三/§五。
