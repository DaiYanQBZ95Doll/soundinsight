...
> **决赛阶段已开启（2026-09-14 官方公示）**：148 → **50 支战队**入围，本团队序号 **15**（更新世界的锋芒 / SoundInsight）；**决赛作品提交截止 10 月 8 日** → 组委会线上评审出 **6 支** → 晋级线下路演，需准备 **10–15 分钟 PPT 分享**。事实与待办见 `docs/finals_stage.md`；该公示页未说明决赛提交物格式，勿以推测填充。
