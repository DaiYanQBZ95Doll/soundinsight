...
- **决赛入围（2026-09-14 官方公示，用户告知 + 页面已核验）**：148 → **50 支战队**，本团队序号 **15**；官方公示页 <https://builderx.csdn.net/activity-site/ceshi1/bansaimingdan> 正文含"更新世界的锋芒 / SoundInsight"。新时间线：**决赛作品提交截止 10 月 8 日** → 线上评审出 **6 支** → 线下路演，需准备 **10–15 分钟 PPT 分享**。据此修正项目内此前"路演 23 日"的假设。决赛待办见 `docs/finals_stage.md`（决赛材料格式待组委会通知、高音 F1=0 修复 C1/C2 待选、10–15 分钟 PPT、答辩题库扩充、口径纪律延续）。决赛属新一轮提交，复赛包仍按红线 9 冻结。
