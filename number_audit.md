...
- [PASS] 阈值 (0\.97): 行 149,179,239,248
...
## README.md
- [PASS] 最终模型 F1 (0\.687): 行 61
- [PASS] 5折CV平均F1 (0\.6234): 行 61
- [PASS] CV标准差 (0\.024): 行 61
- [PASS] 阈值 (0\.97): 行 61
- [PASS] 召回率 (89\.6): 行 61
- [PASS] 精确率 (47\.9): 行 61
- [PASS] SVM基线 (0\.497): 行 61
- [PASS] LR基线 (0\.410): 行 61
- [PASS] dummy基线 (0\.025): 行 61
- [PASS] AUC-PR (0\.7191): 行 61
- [PASS] t检验p值 (0\.000932): 行 61
- [PASS] 正例(实验口径) (1257): 行 57
- [PASS] 人工抽查精度 (78%): 行 61
- [PASS] 三星漏检率 (41\.5%): 行 57
- [PASS] 弱标注精度 (51\.8%): 行 61
- [PASS] 未发现 错误正例数1297
- [PASS] 未发现 教师一致性出现在正文（仅允许方法说明/附录）
- [PASS] 未发现 已废弃的qwen标注复核claim
