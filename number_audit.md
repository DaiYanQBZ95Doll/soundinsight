...
## competition_v4.md
- [PASS] 最终模型 F1 (0\.687): 行 59,143,159,203,207
- [PASS] 5折CV平均F1 (0\.6234): 行 216
- [PASS] CV标准差 (0\.024): 行 216
- [PASS] 阈值 (0\.97): 行 59,159,173,207,210
- [PASS] 召回率 (89\.6): 行 58,208,211,257
- [PASS] 精确率（须标阈值档：0.9744 档 66.3% / 0.5 档 47.9%） (47\.9|66\.3): 行 59,203,207,208,210
- [PASS] SVM基线 (0\.497): 行 199,224
- [PASS] LR基线 (0\.410): 行 223
- [PASS] dummy基线 (0\.025): 行 199,222
- [PASS] AUC-PR (0\.7191): 行 199,244
- [PASS] t检验p值 (0\.000932): 行 227
- [PASS] 正例(实验口径) (1257): 行 143,171,179,183,240
- [PASS] 人工抽查精度 (78%): 行 171,271
- [PASS] 三星漏检率 (41\.5%): 行 39,169
- [PASS] 弱标注精度 (51\.8%): 行 171
- [PASS] 未发现 错误正例数1297
- [PASS] 未发现 教师一致性出现在正文（仅允许方法说明/附录）
- [PASS] 未发现 已废弃的qwen标注复核claim

## README.md
- [PASS] 最终模型 F1 (0\.687): 行 80
- [PASS] 5折CV平均F1 (0\.6234): 行 80
- [PASS] CV标准差 (0\.024): 行 80
- [PASS] 阈值 (0\.97): 行 16,80
- [PASS] 召回率 (89\.6): 行 80
- [PASS] 精确率（须标阈值档：0.9744 档 66.3% / 0.5 档 47.9%） (47\.9|66\.3): 行 80
- [PASS] SVM基线 (0\.497): 行 80
- [PASS] LR基线 (0\.410): 行 80
- [PASS] dummy基线 (0\.025): 行 80
- [PASS] AUC-PR (0\.7191): 行 80
- [PASS] t检验p值 (0\.000932): 行 80
- [PASS] 正例(实验口径) (1257): 行 76
- [PASS] 人工抽查精度 (78%): 行 80
- [PASS] 三星漏检率 (41\.5%): 行 76
- [PASS] 弱标注精度 (51\.8%): 行 80
- [PASS] 未发现 错误正例数1297
- [PASS] 未发现 教师一致性出现在正文（仅允许方法说明/附录）
- [PASS] 未发现 已废弃的qwen标注复核claim
